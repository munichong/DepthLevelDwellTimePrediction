...
#         print(pv_index+1, "/", len(pageviews))
        ...
        hashed_cha_group = [(hashstr('='.join(['chans', cha])), 1) for cha in pv.pagelevel_auxfeats['channel_group']]
        hashed_sec_group = [(hashstr('='.join(['secs', sec])), 1) for sec in pv.pagelevel_auxfeats['section_group']]

        hashed_page_meta = [(hashstr('='.join(['len', pv.pagelevel_auxfeats['length']])), 1),
