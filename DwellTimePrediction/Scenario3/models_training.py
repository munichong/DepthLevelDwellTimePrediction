...
#         rnn = FNN_onestep_c(len(mig.vectorizer.feat_dict), mig.unique_users_num, mig.unique_pages_num)
    ...
    for epoch in range(1, NUM_EPOCH+1):
        ...
        for X_batch_ctx, X_batch_dep, X_batch_u, X_batch_p, y_batch in mig.Xy_gen(mig.training_examples, batch_size=BATCH_SIZE):
            batch_index += 1
...
#             print((len(mig.vectorizer.feat_dict), mig.unique_users_num, mig.unique_pages_num))
    ...
    for X_batch_ctx, X_batch_dep, X_batch_u, X_batch_p, y_batch in mig.Xy_gen(mig.test_examples, batch_size=BATCH_SIZE):
